...
type Nonstandard = 'Past' | 'Future' | 'Unobtainable' | 'CAP' | 'LGPE' | 'Custom' | 'Gigantamax' | 'PKF'; // MODIFICADO PARA PKFABRICA
...
namespace TierTypes {
	...
	export type Other = "Unreleased" | "Illegal" | "CAP" | "CAP NFE" | "CAP LC" | "PKF"; // MODIFICADO PARA PKFABRICA
}
