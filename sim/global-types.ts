...
type Nonstandard = 'Past' | 'Future' | 'Unobtainable' | 'CAP' | 'LGPE' | 'Custom' | 'Gigantamax' | 'PXP'; // MODIFICADO PARA PXP
...
namespace TierTypes {
	...
	export type Other = "Unreleased" | "Illegal" | "CAP" | "CAP NFE" | "CAP LC" | "PXP"; // MODIFICADO PARA PXP
}
